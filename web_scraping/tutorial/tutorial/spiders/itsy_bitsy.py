...
class ItsyBitsySpider(CrawlSpider):
    ...
    start_urls = [
        ...
        'https://bip.uml.lodz.pl/urzad-miasta/przetargi/zamowienia-publiczne-powyzej-30000-euro/?tx_edgepublicorder_order[order]=1142&tx_edgepublicorder_order[action]=show&tx_edgepublicorder_order[controller]=Order'
    ]
    def __init__(self, *args, **kwargs):
        self.rules = (Rule(CustomLinkExtractor(), follow=False, callback="parse_item"),)
